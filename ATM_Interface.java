...
class BankAccount {
    ...
    void checkId() {
        ...
        System.out.println();
        System.out.print("Please Enter The Customer ID or PIN To Continue with transaction\n");
    ...
    void withdraw(int amount) {
        if (this.balance > amount) {
            ...
            System.out.println("insufficient balance to initiate transaction !");
    ...
    public void transfer(double amount, BankAccount acc) {
        if (this.balance < amount) {
            ...
            System.out.println("Transaction Failed because of insufficient balance ");
        ...
        do {
            ...
            switch (option) {
                ...
                case '5':
                    clrscr();
                    System.out.println("*******");
                    System.out.println("To whom you want to transfer");
                    BankAccount bb = new BankAccount("akhil darsi", "20505");
...
public class ATM_Interface {
    ...
    public static void main(String[] args)
    {
        ...
        BankAccount ba = new BankAccount("balu", "10523");
        ba.checkId();
    }
